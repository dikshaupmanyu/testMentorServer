...
function getSoicalChatroomOne() {
 ...
 function getGroupDetailroomOnes() {
  ...
  function getSoicalChatroomOnes() {
...
function handleCreate(event) {
  ...
  if(message.value != ""){
    ...
    commentBody: message.value,
    messageId : loggedInVal + "_"+  Date.now(),
    messageType : "text",
    createdOn :  Date.now(),
    profileImageUrl : "https://apistest.tradetipsapp.com/api/appUser/getImageByAppUserId?appUserId="+loggedInVal,
    messageSource : "Web",
    socialSiteName : "TradeTips",
    userId : loggedInVal ,
...
function getoutput(event,id) {
  ...
  const docRefreply = db.collection("/socialchat/Test/messages/"+id+"/replies/");
...
function popupCreate(event) {
  ...
  // alert(fullName.value);
   ...
   const docReply = db.collection("/socialchat/Test/messages/"+uniqueDocId+"/replies/"); 
   // alert(docReply);
...
function handleDeleteReply(obj1,obj2) {
    ...
    const docRefreply = db.collection("/socialchat/Test/messages/"+obj2+"/replies/");
    var txt;
          if (confirm("Are you sure you want to delete this chat ?")) {
             return docRefreply
            .doc(obj1)
...
//     querySnapshot.docChanges().forEach(function(change) {
     ...
     docRef.orderBy("createdOn", "desc").limit(100).onSnapshot(function(snapshot) {
        snapshot.docChanges().reverse().forEach(function(change) {

          // console.log(change.doc.id);

         const docRefreply = db.collection("/socialchat/Test/messages/"+change.doc.id+"/replies/");
           docRefreply.orderBy("createdDate", "asc").onSnapshot(function(snapshots) {       
...
// });
 ...
 function fetchTasksReply(id) {
    ...
    var docId     = id;
      const docRefreply = db.collection("/socialchat/Test/messages/"+docId+"/replies/");
...
// //   }
// // });
function reviewTemplate({profileImageUrl,authorName,userId, commentBody,createdOn,messageType,messageId},loggedInName,loggedInVal,taskId) {

  // console.log("userid " + userId);
 // console.log("logged In " + loggedInName);

                const date = new Date(createdOn); //new Date(createdDate).toDateString();
                  //console.log(date);
            ...
            <div class="Overlay">
                <div class="Overlay-1">
                  ...
                  <div class="header clearfix">
                      ...
                      <strong class="right primary-font" class='fullName'>${authorName}</strong>
                  </div>
                  <p class='message' id="${taskId}">
                      <span id='textMessage${taskId}'>${commentBody} <svg class="Chevron" onclick="TogglePopup(this.id)" id="${taskId}"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                      width="24" height="24"
                      viewBox="0 0 172 172"
                  ...
                  <form id="${taskId}">
                    ...
                    <div class="modal-content" id="modal-content-1">
                      ...
                      <div class="msg-body" style="padding:5px; padding-left:8px">
                        <h5>${authorName} : <label class="msg-detail"> ${commentBody}</label></h5> 
                      </div>
            ...
            <li class="admin clearfix">
              ...
              <div class="Overlay">
                  ...
                  <div class="header clearfix">
                    ...
                    <p class='message'><img src="${commentBody}" class="img-responsive" style="width:200px;"/> <svg class="Chevron" onclick="TogglePopup(this.id)" id="${taskId}"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="24" height="24"
                    viewBox="0 0 172 172"
          ...
          return `
            ...
            <li class="admin clearfix">
              ...
              <div class="Overlay">
                 ...
                 <p class='message'><video controls style="width:100%;"><source src="${commentBody}" type="video/mp4"></video> <svg class="Chevron" onclick="TogglePopup(this.id)" id="${taskId}"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                 width="24" height="24"
                 viewBox="0 0 172 172"
                 style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M124.36689,70.61689l-35.83333,35.83333c-0.67183,0.67205 -1.58315,1.04963 -2.53342,1.04963c-0.95026,0 -1.86159,-0.37757 -2.53342,-1.04963l-35.83333,-35.83333c-1.35798,-1.40602 -1.33856,-3.64097 0.04365,-5.02318c1.38221,-1.38221 3.61716,-1.40163 5.02318,-0.04365l33.29977,33.29977l33.29977,-33.29985c1.40602,-1.35798 3.64097,-1.33856 5.02318,0.04365c1.38221,1.38221 1.40163,3.61716 0.04365,5.02318z"></path></g></g></svg>
                 </p>
          ...
          return `
            ...
            <li class="admin clearfix">
              ...
              <div class="Overlay">
                  ...
                  <p class='message'><a href="${commentBody}" target="_blank">  <svg class="Chevron" onclick="TogglePopup(this.id)" id="${taskId}"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  width="24" height="24"
                  viewBox="0 0 172 172"
                  style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M124.36689,70.61689l-35.83333,35.83333c-0.67183,0.67205 -1.58315,1.04963 -2.53342,1.04963c-0.95026,0 -1.86159,-0.37757 -2.53342,-1.04963l-35.83333,-35.83333c-1.35798,-1.40602 -1.33856,-3.64097 0.04365,-5.02318c1.38221,-1.38221 3.61716,-1.40163 5.02318,-0.04365l33.29977,33.29977l33.29977,-33.29985c1.40602,-1.35798 3.64097,-1.33856 5.02318,0.04365c1.38221,1.38221 1.40163,3.61716 0.04365,5.02318z"></path></g></g></svg>
        ...
        <li class="agent clearfix">
          ...
          <div class="overlay">
              ...
              <div class="header clearfix">
                  ...
                  <strong class="primary-font" class='fullName' style="color: #000">${authorName}</strong>
              </div>
        ...
        <div class="overlay">
            <div class="overlay-1">
             ...
             <video controls style="width:200px;">
              <source src="${commentBody}"type="video/mp4">
             </video>
        ...
        <li class="agent clearfix">
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
            <div class="overlay">
              ...
              <p class='message' style="color: #000 !important">
             <img src="${commentBody}"   style="width:200px;"/> <img class="chevron" onclick="togglePopup(this.id)" id="${taskId}" src=" https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/000000/external-chevron-arrow-line-royyan-wijaya-detailed-outline-royyan-wijaya.png" />
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
            <div class="overlay">
              ...
              <div class="header clearfix">
               ...
               <p class='message'><a href="${commentBody}" target="_blank"> <img class="chevron" onclick="togglePopup(this.id)" id="${taskId}" src=" https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/000000/external-chevron-arrow-line-royyan-wijaya-detailed-outline-royyan-wijaya.png" />
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  width="25" height="25"
                  viewBox="0 0 172 172"
                  style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ecf0f1"><path d="M44.79167,14.33333c-8.89025,0 -16.125,7.23475 -16.125,16.125v111.08333c0,8.89025 7.23475,16.125 16.125,16.125h82.41667c8.89025,0 16.125,-7.23475 16.125,-16.125v-69.875h-41.20833c-8.89025,0 -16.125,-7.23475 -16.125,-16.125v-41.20833zM96.75,17.48275v38.05892c0,2.96342 2.41158,5.375 5.375,5.375h38.05892z"></path></g></g></svg>
        ...
        <li class="agent clearfix">
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
            ...
            <div class="overlay">
              ...
              <p class='message'><a href="${commentBody}" target="_blank" style="color:black"> <img class="chevron" onclick="togglePopup(this.id)" id="${taskId}" src=" https://img.icons8.com/external-royyan-wijaya-detailed-outline-royyan-wijaya/24/000000/external-chevron-arrow-line-royyan-wijaya-detailed-outline-royyan-wijaya.png" />
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              width="25" height="25"
              viewBox="0 0 172 172"
        ...
        if(messageType == "text"){
              ...
              <div class="Overlay-1">
                <div class="Content"  id='Popup${docId}'>
                  ...
                  <p class='message' onClick='copyClipboard(this.id)' id="${createdDate}">
                      <span id='divClipboard${createdDate}'>${commentBody}<span>
                  </p>
              </div>
          </li>
          `
            ...
            <div class="Overlay">
                <div class="Overlay-1">
                  ...
                  <div class="header clearfix">
                    ...
                    <p class='message'><img src="${commentBody}" class="img-responsive" style="width:200px;"/></p>
              </div>
          </li>
          `
          ...
          return `
            ...
            <div class="Overlay">
                <div class="Overlay-1">
                 ...
                 <p class='message'><video controls style="width:100%;"><source src="${commentBody}" type="video/mp4"></video></p>
              </div>
          </li>
          `
        } else if(messageType == "document"){
          ...
          return `
            ...
            <div class="Overlay">
                <div class="Overlay-1">
                 ...
                 <p class='message'><a href="${commentBody}" target="_blank">click here to download pdf</a></p>
              </div>
          </li>
          `
        } 
          ...
          return `
            ...
            <div class="Overlay">
                ...
                <p class='message'><audio controls><source src="${commentBody}" type="audio/mpeg"></audio></p>              </div>
          </li>
          `
     ...
     if(messageType == "text"){
        ...
        <li class="agent clearfix">
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
              ...
              <p class='message' style="color: #000 !important">
                      <span id="textMessage${createdDate}">${commentBody}<span>
                  </p>
          </div>
      </li>
      `
        ...
        <li class="agent clearfix">
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
             ...
             <p class='message' style="color: #000 !important"><video controls style="width:100%;"><source src="${commentBody}" type="video/mp4"></video></p>
      ...
      `
        ...
        <li class="agent clearfix">
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
              ...
              <p class='message' style="color: #000 !important"><img src="${commentBody}" class="img-responsive" style="width:200px;"/></p>
      ...
      `
        ...
        <li class="agent clearfix">
          ...
          <div class="chat-body clearfix agent" style="float:none;background:#77839647;color:#000;">
              ...
              <p class='message' style="color: #000 !important"><audio controls><source src="${commentBody}" type="audio/mpeg"></audio></p>            
